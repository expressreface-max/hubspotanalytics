...
const seed = [
  ...
  // Jun–Aug 2026 backfilled from Kitchens Now QuickBooks (60100 Advertising Expense).
  ["2026-06", 69110.58, 42282.19, 5525],
  ["2026-07", 64440.45, 51431.06, 5945],
  ["2026-08", 49129.45, 0, 0],
]
